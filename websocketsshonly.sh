...
wget -q -O /usr/local/bin/edu-ovpn "https://raw.githubusercontent.com/reyvoid09-ops/aws/main/lain2/ovpn.py"
...
Documentation=https://github.com/reyvoid09-ops/aws
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/reyvoid09-ops/aws/main/lain2/dropbear-ws.py"
...
wget -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/reyvoid09-ops/aws/main/lain2/ws-stunnel.py"
